...
//            Log.d("测试",result.getMostProbableActivity().getType()+"");
            ...
            Log.d("ME/ActivityRecogition",PreActivity.getPreActivity());
            PreActivity.setLabel(activity);
            Log.d("MbiE/ActivityRecogition",PreActivity.getPreActivity());
